...
print(f"Se demoró {elapsed:2.2f} segundos - Enfoque procedural")
...
print(f"Se demoró {elapsed:2.2f} segundos - Usando Partial")
assert result == 28671512
...
print(f"Se demoró {elapsed:2.2f} segundos - Usando un decorador")
assert result == 28671512
...
print(f"Se demoró {elapsed:2.2f} segundos - Usando un decorador con sintaxis especial")
assert result == 28671512


# Una caso real de este patrón es para guardar en una memoria cache auxiliar
# resultados de funciones que son muy costosas computacionalmente. A este patrón
# se lo suele denominar memoized


# Escribir una función memoized y utilizarla como decorador junto con medir_tiempo
# para la función calcular posibilidades. Prestar atención a los tiempo de ejecución
...
result, elapsed = calcular_posibilidades(lista, limite)
print(f"Se demoró {elapsed:2.2f} segundos - Con Memoized - 1ra ejecución")
assert result == 28671512

result, elapsed = calcular_posibilidades(lista, limite)
print(f"Se demoró {elapsed:2.8f} segundos - Con Memoized - 2da ejecución")
assert result == 28671512

result, elapsed = calcular_posibilidades(lista, limite)
print(f"Se demoró {elapsed:2.8f} segundos - Con Memoized - 3ra ejecución")
assert result == 28671512
...
print(f"Se demoró {elapsed:2.2f} segundos - Recursiva Con Memoized - 1ra Ejecución")
assert result == 28671512

result, elapsed = calcular_posibilidades_recursiva(lista, limite)
print(f"Se demoró {elapsed:2.8f} segundos - Recursiva Con Memoized - 2da Ejecución")
assert result == 28671512

print()

result, elapsed = calcular_posibilidades(lista, limite + 1)
print(f"Se demoró {elapsed:2.2f} segundos - Bucles Con Memoized - Parametro + 1")
assert result == 68588312

result, elapsed = calcular_posibilidades_recursiva(lista, limite + 1)
print(f"Se demoró {elapsed:2.8f} segundos - Recursiva Con Memoized - Parametro + 1")
assert result == 68588312

print()

result, elapsed = calcular_posibilidades(lista, limite + 2)
print(f"Se demoró {elapsed:2.2f} segundos - Bucles Con Memoized - Parametro + 2")
assert result == 108505112

result, elapsed = calcular_posibilidades_recursiva(lista, limite + 2)
print(f"Se demoró {elapsed:2.8f} segundos - Recursiva Con Memoized - Parametro + 2")
assert result == 108505112
